...
<!-- 			<nut-popup v-model="showLogin" :close-on-click-overlay="false" v-if="load">
				<div class="lgBox">
					<p>登录</p>
					<nut-textinput 
					    v-model="name"
		...
		<full-page :options="options" ref="fullpage" v-show="load">
			<div class="section">
				 <!-- @click="njPlay()" -->
				...
				<!--  @touchstart="gtouchstart()" @touchmove="gtouchmove()"
					@touchend="gtouchend()" -->
				<div class="slide page1">
					<div class="content">
						<!--  :class="{'go':go}" @click="goNext" -->
<!-- 						<div class="man">
							<img width="100%" :src="`images/year/0000${idx}.png`" alt="">
						</div> -->
						...
						<div class="mtext p1-text" v-if="!isPP">
							<p>你是第<span>{{my.EmpNo}}</span>位小原</p>
							<p>成为了中原的一份子</p>
						</div>
						<div class="mtext p1-text" v-else>
							<p>在<span>{{my.InCompanyDate}}</span>月，你成为了中原的一份子</p>
						</div>
<!-- 						<div class="p1-nj1"></div>
				...
				<div class="slide page3">
					<div class="content">
						...
						<div class="p3-text">
							...
							<p>优秀的你打败了</p>
							<p>中原<span>{{my.EmpRate*100}}</span>%的经纪人</p>
						</div>
						<div class="p3-man">
				...
				<div class="slide page4">
					<div class="content">
						...
						<div class="p4-text">
							...
							<p>你替他点亮了一盏属于他的一盏灯</p>
							<p>替<span>{{my.SalesCount}}</span>个房源找到了它的新主人</p>
						</div>
						<div class="p4-mtl"></div>
						<div class="p4-lb"></div>
						<div class="goRight man peapo" :class="goFast?'fast':'goRight'" @touchstart="gtouchstart()" @touchend="gtouchend()" v-if="my.Sex=='男'">
						</div>
						<div class="goRight woman peapo" :class="goFast?'fast':'goRight'" @touchstart="gtouchstart()" @touchend="gtouchend()" v-else></div>
					</div>
				</div>
				<div class="slide page5">
					<div class="content">
						...
						<div class="p5-text">
							<p>进线不等待，成交就现在</p>
							<p v-if="my.SalesAmount>100000">今年你促成了<span>{{my.SalesAmount | twoFixed}}</span>万的成交额</p>
							<p v-else>今年你促成了大笔成交额</p>
						</div>
						<div class="p5-man">
				...
				<div class="slide page6">
					<div class="content">
						...
						<div class="p6-text">
							...
							<p>带着客户到<span>{{my.TakeSeeEstate}}</span>小区</p>
							<p>看了个前前后后</p>
							<p>真诚服务流出的汗</p>
							<p>足以浇灌出苍天大树</p>
						</div>
				...
				<div class="slide page7">
					<div class="content">
						...
						<div class="p7-text">
							<p>迈出一小步，成功一大步</p>
							<p><span>{{my.BindCount}}</span>人因为你的专业服务</p>
							<p>更加信任中原找房</p>
						</div>
						<div class="p7-man">
				...
				<div class="slide page8">
					<div class="content">
						...
						<div class="p8Map">
							<span class="ba"><img src="images/year/ba.png" width="100%" v-if="qy.indexOf('ba')<0"/><template v-else><img src="images/year/ba1.png" width="100%" class="qyD"/><img src="images/year/cicle.png" class="cicle"/></template></span>
							<span class="gm"><img src="images/year/gm.png" width="100%" v-if="qy.indexOf('gm')<0"/><template v-else><img src="images/year/gm1.png" width="100%" class="qyD"/><img src="images/year/cicle.png" class="cicle"/></template></span>
							<span class="ns"><img src="images/year/ns.png" width="100%" v-if="qy.indexOf('ns')<0"/><template v-else><img src="images/year/ns1.png" width="100%" class="qyD"/><img src="images/year/cicle.png" class="cicle"/></template></span>
							<span class="lh"><img src="images/year/lh.png" width="100%" v-if="qy.indexOf('lh')<0"/><template v-else><img src="images/year/lh1.png" width="100%" class="qyD"/><img src="images/year/cicle.png" class="cicle"/></template></span>
							<span class="ft"><img src="images/year/ft.png" width="100%" v-if="qy.indexOf('ft')<0"/><template v-else><img src="images/year/ft1.png" width="100%" class="qyD"/><img src="images/year/cicle.png" class="cicle"/></template></span>
							<span class="lg"><img src="images/year/lg.png" width="100%" v-if="qy.indexOf('lg')<0"/><template v-else><img src="images/year/lg1.png" width="100%" class="qyD"/><img src="images/year/cicle.png" class="cicle"/></template></span>
							<span class="lhu"><img src="images/year/lhu.png" width="100%" v-if="qy.indexOf('lhu')<0"/><template v-else><img src="images/year/lhu1.png" width="100%" class="qyD"/><img src="images/year/cicle.png" class="cicle"/></template></span>
							<span class="ps"><img src="images/year/ps.png" width="100%" v-if="qy.indexOf('ps')<0"/><template v-else><img src="images/year/ps1.png" width="100%" class="qyD"/><img src="images/year/cicle.png" class="cicle"/></template></span>
							<span class="yt"><img src="images/year/yt.png" width="100%" v-if="qy.indexOf('yt')<0"/><template v-else><img src="images/year/yt1.png" width="100%" class="qyD"/><img src="images/year/cicle.png" class="cicle"/></template></span>
							<span class="dp"><img src="images/year/dp.png" width="100%" v-if="qy.indexOf('dp')<0"/><template v-else><img src="images/year/dp1.png" width="100%" class="qyD"/><img src="images/year/cicle.png" class="cicle"/></template></span>
						</div>
						<div class="p4-mtl"></div>
						<div class="p4-lb"></div>
				...
				<div class="slide page9">
					<div class="content">
						...
						<div class="p9-text">
							...
							<p>别不信！</p>
							<p>这足以绕深圳<span>{{my.TurnsNumber}}</span>圈</p>
						</div>
				...
				<div class="slide page10">
					<div class="content">
						...
						<div class="p10-text">
							<p>印象最深的客户，你还记得吗</p>
							<p v-if="my.WebChatStr">那天的<span>{{my.WebChatStr}}</span>时间</p>
							<p v-else>那天的月亮都睡着了</p>
							<p>你还在为了他的安家梦而努力</p>
						</div>
						<div class="p10-man">
				...
				<div class="slide page11">
					<div class="content">
						...
						<div class="man" :class="{'go':go}" @click="goNext12" v-if="my.Sex=='男'">
						</div>
						<div class="woman" :class="{'go':go}" @click="goNext12" v-else>
						</div>
				...
				<div class="slide page12">
					<div class="content">
						...
						<div class="p12-flag">
							<label class="flg1" :class="flag==1?'on':''" @click="setFlag(1,'成功脱单，拥抱幸福')">
								<span>成功脱单，拥抱幸福</span>
							</label>
							<label class="flg2" :class="flag==2?'on':''" @click="setFlag(2,'管住嘴，迈开腿')">
								<span>管住嘴，迈开腿</span>
							</label>
							<label class="flag3" :class="flag==3?'on':''" @click="setFlag(3,'做值得信赖的中原人')">
								<span>做值得信赖的中原人</span>
							</label>
							<label class="flg4" :class="flag==4?'on':''" @click="setFlag(4,'学会理财，珍惜血汗钱')">
								<span>学会理财，珍惜血汗钱</span>
							</label>
							<label class="flg5" :class="flag==5?'on':''" @click="setFlag(5,'万事顺意，美好相随')">
								<span>万事顺意，美好相随</span>
							</label>
							<label class="flg6" :class="flag==6?'on':''" @click="setFlag(6,'做2022开单王')">
								<span>做2022开单王</span>
							</label>
							<label class="flg7" :class="flag==7?'on':''" @click="setFlag(7,'多陪家人，常回家看看')">
								<span>多陪家人，常回家看看</span>
							</label>
							<label class="flg8" :class="flag==8?'on':''" @click="setFlag(8,'积极向上，原气满满')">
								<span>积极向上，原气满满</span>
							</label>
							<label class="flg9" :class="flag==9?'on':''" @click="setFlag(9,'陪值得的人岁岁年年')">
								<span>陪值得的人岁岁年年</span>
							</label>
							<label class="flg10" :class="flag==10?'on':''" @click="setFlag(10,'继续奔走自己的热爱里')">
								<span>继续奔走自己的热爱里</span>
							</label>
						</div>
						<div class="man" v-if="my.Sex=='男'">
						</div>
...
<!-- 						<div class="p12-btn">
				...
				<div class="slide page13">
					<div class="content">
						<div class="p13Bj">
							<img src="images/year/canvas.jpg" width="100%" id="scream" style="display: none;" crossOrigin='anonymous'/>
							<img src="https://pic.centanet.com/shenzhen/pic/agent/103365.jpg" id="tx" style="display: none;" />
							<!-- <img src="images/year/txNone.jpg" id="tx" style="display: none;" v-else/> -->
							<vue-qr :text="downloadData.url" :margin="0" colorDark="#000" colorLight="#fff" :logoSrc="imageUrl" :logoScale="0.2" :size="200" ref="Qrcode" style="display: none;"></vue-qr>
							<!-- <img src="images/year/p13.jpg?v=5" width="100%" id="scream" style="display: none;"/> -->
	...
	export default {
		...
		methods: {
			...
			posterHb(){
				...
				img.setAttribute('crossOrigin','anonymous')	;
				img.src="https://pic.centanet.com/shenzhen/pic/agent/103365.jpg";
				
				var img1 =new Image();
				img1.onload=()=>{
					ctx.drawImage(img1,320,1317,108,108);
				}
				img1.setAttribute('crossOrigin','anonymous')	;
				img1.src="https://static.centanet.com/vue/img/user.png";
				...
				img2.src="images/year/canvas.jpg";
				...
				// ctx.drawImage(ewm,320,1317,108,108);
					...
					ctx.font="34px PingFangSC-Regular";
					ctx.fillStyle="rgba(231, 21, 51, 1)";
					ctx.fillText(`优秀的你打败了中原`,109,854);
					ctx.fillText('的经纪人',510,854);
					ctx.font="bold 43px PingFangSC-Regular";
					ctx.fillStyle="rgba(231, 21, 51, 1)";
					ctx.fillText(`${this.my.EmpRate*100}%`,418,856);
					ctx.font="30px SourceHanSansCN-Regular";
					ctx.fillStyle="#fff";
					ctx.fillText(`2022年flag：${this.flag}`,115,1188);
...
<style lang="less" scoped>
	...
	.container {
		...
		.page2{
			...
			.p2-phone{
				...
				.p2-msg{
					...
					// bottom: 0.2rem;
					// right: 0.25rem;
					animation: goUp linear 5s infinite;
				}
				.p2-msg1{
					width: 2.29rem;
					height: 4.06rem;
		...
		.page8{
			...
			.p8Map{
				...
				span{
					...
					img.qyD{animation: pulse 2s ease infinite;}
				}
				span.gm{
					position: absolute;
					left: 1.24rem;
		...
		.page10{
			...
			.p10-man{
				...
				.p10-m{
					width: 1.61rem;
					height: 5.5rem;
					background: url(../images/year/p10-man.png) center bottom no-repeat;
					background-size: 100%;
					position: absolute;
					left: 0;
					bottom: 0;
				...
				.p10-m1{
					width: 1.61rem;
					height: 5.5rem;
					background: url(../images/year/p10-woman.png) center bottom no-repeat;
					background-size: 100%;
					position: absolute;
					left: -0.2rem;
					bottom: 0;
		...
		.page11{
			background: url(../images/year/p11Bj.jpg) center bottom no-repeat;
			background-size: cover;
			.p11-ty{
				.son;
				background: url(../images/year/p9-ty.png) center bottom no-repeat;
	...
	// 统一动画
	// 元素入场
	.p1-text,.p2-text,.p1-text,.p3-text,.p4-text,.p5-text,.p6-text,.p7-text,.p8-text,.p9-text,.p10-text,.p11-text,.p12-text{
		display: none;
	}
	.content{
		display: none;
